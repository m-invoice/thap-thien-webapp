    ...
    <main className="min-h-screen bg-black text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 xl:grid-cols-5 gap-4 mb-8">
          ...
          <div className="border border-white/20 rounded-2xl p-6">
            <div className="text-white/60 text-sm">Tổng số câu đã làm</div>
            <div className="text-3xl font-bold mt-2">{totalQuestions}</div>
          </div>

          <div className="border border-white/20 rounded-2xl p-6">
            <div className="text-white/60 text-sm">Tổng số câu đúng</div>
          ...
          <div className="border border-white/20 rounded-2xl p-6">
            <div className="text-white/60 text-sm">Tỷ lệ đúng tổng thể</div>
            <div className="text-3xl font-bold mt-2">
        ...
        <div className="grid xl:grid-cols-3 gap-6 mb-6">
          <div className="xl:col-span-2 border border-white/20 rounded-2xl p-6">
            ...
            {dailyStats.length === 0 ? (
              <div className="text-white/60">Chưa có dữ liệu để vẽ tiến bộ.</div>
            ) : (
            ...
            {recommendation ? (
              <div className="space-y-4">
                <div className="border border-white/10 rounded-xl p-4">
                  <div className="text-white/60 text-sm">Chủ đề cần ưu tiên</div>
        ...
        <div className="grid xl:grid-cols-3 gap-6 mb-6">
          <div className="xl:col-span-2 border border-white/20 rounded-2xl p-6">
            ...
            {recentAttempts.length === 0 ? (
              <div className="text-white/60">Chưa có dữ liệu bài thi.</div>
            ) : (
              <div className="space-y-4">
                      ...
                      {attempt.topics?.slug && (
                        <div className="mt-4 flex gap-3 flex-wrap">
                          <a
                            ...
                            className="inline-block px-3 py-2 text-sm border border-white/20 rounded-lg hover:bg-white/5"
                          >
                            Xem bài
                          </a>
          ...
          <div className="space-y-6">
            <div className="border border-white/20 rounded-2xl p-6">
              ...
              {topTopics.length === 0 ? (
                <div className="text-white/60">Chưa có dữ liệu chủ đề.</div>
              ) : (
                <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        {item.slug !== 'unknown' && (
                          <a
                            ...
                            className="text-sm px-3 py-2 border border-white/20 rounded-lg hover:bg-white/5"
                          >
                            Xem
                          </a>
                        )}
            ...
            <div className="border border-white/20 rounded-2xl p-6">
              ...
              {weakTopics.length === 0 ? (
                <div className="text-white/60">Chưa có dữ liệu đánh giá.</div>
              ) : (
                <div className="space-y-4">
